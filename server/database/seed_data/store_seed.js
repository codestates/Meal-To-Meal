...
function calculatedStoreOrderQuantity(store_id) {
  const totalQuantity = menu
    .filter(menu => menu.store_id === store_id)
    .reduce((acc, cur) => cur.menu_order_quantity + acc, 0);
  return totalQuantity;
}

const incrementer = storeId();
...
const store = [
  {
    ...
    store_order_quantity: calculatedStoreOrderQuantity(incrementer()),
