...
function LoginModal({ openLoginModalHandler }) {
        ...
        <div className="login-modal-window" onClick={e => e.stopPropagation()}>
          <div className="login-info-container">
            ...
            <div className="login-input-container">
              <div className="login-text">User Id</div>
              <input className="login-input" placeholder="id" onKeyPress={enterKey}></input>
              ...
              <div className="login-button-container">
                ...
                <div className="login-signup-link">Sign up</div>
              </div>
